    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(auth)
            .addPathPatterns("/api/analyze", "/api/refresh", "/api/trigger", "/api/rerun-blockers",
                "/api/rerun-suite", "/api/rerun-suites", "/api/runs", "/api/cancel-all", "/api/update", "/api/restart", "/api/users", "/api/jira-token", "/api/jira-visa", "/api/auto-visa", "/api/auto-visa-cancel", "/api/test-details",
