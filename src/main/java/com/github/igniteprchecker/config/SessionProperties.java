 ...
 * There is no session timeout — a login lasts until logout. {@code cookieSecure} must be true behind
 * HTTPS/Caddy so the cookie is only ever sent over TLS.
 */
@ConfigurationProperties(prefix = "session")
public record SessionProperties(Boolean cookieSecure, String secret) {
